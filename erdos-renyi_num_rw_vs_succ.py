...
#G = nx.read_graphml("10v_erdos_renyi.graphml", node_type=int)
#G = nx.read_graphml("20v_erdos_renyi.graphml", node_type=int)
G = nx.read_graphml("40v_erdos_renyi.graphml", node_type=int)
